...
<head>
	<title>SeL - Stembase e-Library</title>
	<link rel="icon" type="image/png" href="img/favicons/36.png">
	<link rel="manifest" href="img/favicons/manifest.json">
	<link rel="shortcut icon" href="img/favicons/36.png">
...
<body>
	...
	<section id="services" class="section section-padded">
		<div class="container">
			...
			<form role="form" action="search.php#services" method="GET">
			 <div style="padding-left: 27%" class="mtb">
	...
	<div class="container">
		...
		<center><h3 class="page-header">Hasil Pencarian Buku</h3></center>
