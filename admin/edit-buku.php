...
<html lang="en">
 ...
 <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Edit Data Buku<small></small></h2>
                    <div class="clearfix"></div>
                  </div>
			<div id="notif">
			<!-- Message is show here -->
			  	...
			  	<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="judul">Judul Buku</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="judul" placeholder="ID anggota" class="form-control" id="judul" value="<?php echo $row['judul']; ?>" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" name="pengarang" placeholder="Nama" class="form-control" id="pengarang" value="<?php echo $row['pengarang']; ?>" required>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="genre">Genre</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" maxlength="30" name="genre" class="form-control" id="genre" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" maxlength="30" name="isbn" class="form-control" id="isbn" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" maxlength="30" name="penerbit" class="form-control" id="penerbit" required>
					</div>
				</div>
				
				<div class="form-group">
					<label class="control-label col-md-3 col-sm-3 col-xs-12" for="thn_terbit">Tahun Terbit</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
					<input type="text" maxlength="30" name="thn_terbit" class="form-control" id="thn_terbit" required>
					</div>
				</div>
...
?>			
				...
				<a role="button" class="btn btn-primary" id="resetButton" href="daftar_buku.php">Cancel</a>
...
<?php
	...
	if(isset($_POST['editBuku'])){
		...
		$sql = "UPDATE buku SET judul='$judul', pengarang='$pengarang', penerbit='$penerbit', thn_terbit='$thn_terbit', isbn='$isbn', subyek='$subyek' WHERE id_buku='$id' ";
